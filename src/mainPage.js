...
const generate = () => {
  ...
  <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" id="celcius-btn">Celcius</button>
  <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" id="fahr-btn">Farhneit</button>
  </div>
  `;
